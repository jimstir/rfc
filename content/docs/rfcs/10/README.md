...
Waku v2 is family of modular peer-to-peer protocols for secure communication.rving, censorship-resistant and being able to run in resource restricted environments.
